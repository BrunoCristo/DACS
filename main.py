...
app = Flask(__name__)
app.config["MONGO_URI"] = "mongodb://172.18.0.35:27017/DBbrunohc"
mongo = PyMongo(app)

# listClients =[
#     Client(name= "Zezinho", email= "ze@univille.br", phone="5551234"),
#     Client(name= "Joaozinho", email= "jao@univille.br", phone="5554321"),
#     Client(name= "Mariazinha", email= "maria@univille.br", phone="5551243"),
# ]
# def get_tasks():
